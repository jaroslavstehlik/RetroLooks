...
{
    using Settings = RetroBloomModel.Settings;

    [RetroLooksModelEditor(typeof(RetroBloomModel))]
    public class RetroBloomModelEditor : RetroLooksModelEditor
    {
        ...
        {
            var bloom = (RetroBloomModel)target;
            m_RangeX = 5f;
            m_RangeY = 2f;
