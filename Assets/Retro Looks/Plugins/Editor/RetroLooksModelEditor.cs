...
{
    public class RetroLooksModelEditor
    {
        public RetroLooksModel target { get; internal set; }
        ...
        internal RetroLooksProfile profile;
        internal RetroLooksInspector inspector;
