...
VaryingsDefault VertDefault(AttributesDefault v)
{
	...
	o.uv.xy = v.texcoord;
	o.uv.z = _MainTex_TexelSize;
	o.uv0.xy = float2(v.texcoord.x, v.texcoord.y) - texel;
	o.uv0.zw = float2(v.texcoord.x, v.texcoord.y) + texel;
	o.uv1.xy = float2(v.texcoord.x + texel.x, v.texcoord.y - texel.y);
	o.uv1.zw = float2(v.texcoord.x - texel.x, v.texcoord.y + texel.y);
	return o;
}
